...
#valgrind --leak-check=full --show-leak-kinds=all multiCrawler https://thayer.github.io/engs50/ ../pagesThread 2 2
multiCrawler https://thayer.github.io/engs50/ ../pagesThread 2 10
